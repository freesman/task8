...
(function() {
  define('models/listModel',['backbone'], function(Backbone) {
    var SongModel;
...
define('text!templates/song.html',[],function () { return '\n<tr>\n  <td class="view"><span data-bind="text:title"></span><input class = \'edit form-control\', data-bind = \'value:title, events:["keyup"]\'></input></td>\n  <td class="view"><span data-bind="text:author"></span><input class = \'edit form-control\', data-bind = \'value:author, events:["keyup"]\'></input></td>\n  <td class="view"><span data-bind="text:genre"></span><input class = \'edit form-control\', data-bind = \'value:genre, events:["keyup"]\' ></input></td>\n  <td class="destroy">&times;</td>\n</tr>';});
...
(function() {
  define('views/songView',['jquery', 'underscore', 'backbone', 'epoxy', 'text!templates/song.html', 'collections/songs', 'common'], function($, _, Backbone, Epoxy, songTemplate, SongsCollection, Common) {
    var ItemView;
    ItemView = Backbone.Epoxy.View.extend({
      ...
      initialize: function() {
        this.listenTo(this.model, 'filterResetItem', this.filterResetItem);
        return this.listenTo(this.model, 'filterItem', this.filterItem);
      },
      ...
      edit: function(e) {
        ...
        this.$myInput = this.$myTd.children('.edit');
        this.$myValue = this.$myTd.children('span').text();
      ...
      revertOnEscape: function(e) {
        if (e.which === Common.ESC_KEY) {
          return this.close('esc');
        }
      },
      close: function(switcher) {
        if (!this.$myInput.val() || switcher === 'esc') {
      ...
      filterItem: function() {
        ...
        if (titleCheck && authorCheck && genreCheck) {
          if (!this.model.get('filtered')) {
            this.toggleFiltered();
            return this.visibleOff(false);
          }
        } else {
          if (this.model.get('filtered')) {
            this.toggleFiltered();
          }
          return this.visibleOff(true);
        }
      },
      checkAndTest: function(inputVal, modelVal) {
        var tester;
        if (inputVal) {
      ...
      filterResetItem: function() {
        if (this.model.get('filtered')) {
          this.toggleFiltered();
        }
        if (this.$el.hasClass('filterOut')) {
          return this.visibleOff(false);
        }
      },
      visibleOff: function(visible) {
        return this.$el.toggleClass('filterOut', visible);
      },
      routeItem: function() {
        var id, songMass;
...
(function() {
  define('views/appView',['jquery', 'underscore', 'backbone', 'epoxy', 'collections/songs', 'views/songView'], function($, _, Backbone, Epoxy, SongsCollection, ItemView) {
    var AppView;
    AppView = Backbone.Epoxy.View.extend({
      ...
      addSong: function() {
        if (!this.$('#songTitle').val() || !this.$('#songAuthor').val() || !this.$('#songGenre').val()) {
      ...
      filterList: function() {
        this.alert('alert');
        return this.collection.each(function(song) {
          return song.trigger('filterItem');
        });
      },
      routeReset: function() {
        return Backbone.history.navigate('', true);
      ...
      filterReset: function() {
        ...
        return this.collection.each(function(song) {
          return song.trigger('filterResetItem');
        });
      },
        ...
        switch (switcher) {
          case 'add':
            ...
            if (!this.$('#alertWarnAdd').css('display', 'block')) {
              return this.$('#alertWarnAdd').fadeIn(100);
            }
            break;
          case 'filter':
            this.$('#alertWarnAdd').fadeOut(0);
            if (!this.$('#alertWarnFilter').css('display', 'block')) {
              return this.$('#alertWarnFilter').fadeIn(100);
            }
            break;
          case 'alert':
            this.closeAlert();
            if (!this.$('#alertFilter').css('display', 'block')) {
              return this.$('#alertFilter').fadeIn(100);
            }
        }
      },
      closeAlert: function() {
        this.$('#alertWarnAdd').fadeOut(0);
        return this.$('#alertWarnFilter').fadeOut(0);
      }
    });
    return AppView;
  });
